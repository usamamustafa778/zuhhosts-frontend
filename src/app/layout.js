  ...
  return (
    <html lang="en" className={roboto.variable}>
      <head>
        ...
        <meta
          name="description"
          content="Zuha Host - Modern property management platform for Airbnb hosts. Manage bookings, properties, guests, and earnings all in one place."
        />
        <meta
          name="keywords"
          content="property management, Airbnb host, vacation rental, booking management, property rental, host dashboard"
        />
        <meta
          name="viewport"
