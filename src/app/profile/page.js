        ...
        <div className="space-y-0 lg:rounded-2xl lg:border lg:border-slate-200 lg:bg-white lg:shadow-sm border-t border-slate-200 -mx-4 lg:mx-0 lg:overflow-hidden">
          {settingsItems.map((item, index) => (
            <button
              ...
              className={`w-full flex items-center justify-between py-5 px-4 lg:px-6 hover:bg-slate-50 active:bg-slate-100 transition-colors ${index !== settingsItems.length - 1 ? 'border-b border-slate-200' : ''
                }`}
            >
