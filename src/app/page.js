        ...
        <div className={sectionContainer}>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            {[
              ...
              <div
                key={index}
                className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl transition hover:shadow-2xl"
              >
                <div
                  className={`aspect-video bg-gradient-to-br ${screenshot.gradient} flex items-center justify-center`}
                >
